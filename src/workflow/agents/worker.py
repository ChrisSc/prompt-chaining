...
from workflow.models.internal import TaskRequest, TaskResult, TokenUsage
from workflow.models.openai import ChatCompletionChunk, ChatCompletionRequest
        ...
        try:
            ...
            async def _call_api() -> Any:
                ...
                if request_id:
                    ...
                    logger.debug(
                        "Propagating request ID to API call",
