...
from orchestrator_worker.api.limiter import limiter
...
from orchestrator_worker.utils.request_context import set_request_id
...
def create_app() -> FastAPI:
    ...
    async def orchestrator_worker_error_handler(request: Request, exc: TemplateServiceError):  # type: ignore
